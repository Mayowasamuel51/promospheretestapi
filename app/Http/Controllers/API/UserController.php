...
class UserController extends Controller
{
    ...
    {
        $validator = Validator::make($request->all(), [
            'image' => 'image|mimes:jpeg,png,bmp,gif|max:10000',
        ]);
    ...
    public function updatedata(Request $request, $id)
    {
        if (auth('sanctum')->check()) {
            ...
            if ($user_infomation) {
                ...
                $user_infomation->countrys = $request->countrys;
                $user_infomation->phone = $request->phone;
                $user_infomation->location = $request->locations;
                $user_infomation->websiteName = $request->websiteName;
                $user_infomation->messageCompany = $request->messageCompany;
                $user_infomation->aboutMe = $request->aboutMe;
                $user_infomation->brandName = $request->brandName;
                $user_infomation->BirthDate = $request->BirthDate;
                $user_infomation->passport = $request->passport;
                $user_infomation->Language = $request->Language;
                $user_infomation->nin = $request->nin;
                $user_infomation->save();
                return response()->json([
                    'status' => 200,
                    'updated' => $user_infomation
